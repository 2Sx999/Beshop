...
<body>
<!--  -->
<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/editProduct.php" method="post"
    ...
    <table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee"
        ...
        <tr>
            ...
            <td class="ta_01" bgColor="#ffffff">
                ...
                <select name="is_hot">
                    <option value="1"
                            <c:if test="${product.is_hot==1}">selected</c:if> >是
                    </option>
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            for (var i = 0; i < data.length; i++) {
                if (data[i].cid == '${product.category.cid}') {
                    string += "<option value='" + data[i].cid + "' selected>" + data[i].cname + "</option>";
                } else {
                    string += "<option value='" + data[i].cid + "'>" + data[i].cname + "</option>";
                }
            }
